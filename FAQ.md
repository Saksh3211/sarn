...
Or use the convenience script: `./sarn.ps1 Sarn-Run hello.sarn`
...
**A:** No native class system. Use records + methods pattern for OOP. See `advanced/oop.sarn` for examples.
