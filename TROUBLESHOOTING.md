...
```
[EE0001] main.sarn:5:10  unexpected token '}' in table literal
```
...
**Error Message Example:**
```
[EE0010] main.sarn:3:5  redeclaration of 'x' in strict mode
```
...
**Error Message Example:**
```
[EE0011] main.sarn:5:5  cannot assign to const 'MAX'
```
...
**Error Message Example:**
```
[EE0012] main.sarn:3:10  undefined identifier 'count'
```
...
**Error Message Example:**
```
[EE0013] main.sarn:5:10  use of possibly-uninitialized variable 'result'
```
...
**Error Message Example:**
```
[EE0020] main.sarn:2:5  declaration requires either type annotation or initialiser
```
...
**Error Message Example:**
```
[EE0030] main.sarn:3:10  void function returns value
```
...
**Error Message Example:**
```
[EE0031] main.sarn:5:3  missing return value
```
...
**Error Message Example:**
```
[EE0041] main.sarn:2:5  for loop range not numeric type
```
...
**Error Message Example:**
```
[EE0050] main.sarn:5:5  store requires a pointer target
```
...
**Error Message Example:**
```
[EE0051] main.sarn:8:5  free requires a pointer argument
```
...
**Error Message Example:**
```
[EE0070] main.sarn:3:5  trying to call non-function value
```
...
**Error Message Example:**
```
[EE0071] main.sarn:5:5  function 'add' expects 2 arguments, got 3
```
...
**Error Message Example:**
```
[EE0092] main.sarn:5:10  type mismatch: 'string' assigned to 'int'
```
